...
function PlacementOfficerSidebar({ activeTab, setActiveTab, onLogout }) {
  const tabs = [
    { name: "Dashboard", key: "dashboard" },
    { name: "Add Job", key: "addJob" },
    { name: "Manage Jobs", key: "manageJobs" },
    { name: "Student Applications", key: "applications" },
    { name: "Placement Results", key: "results" },
  ];
...
export default PlacementOfficerSidebar;
